...
function Expenseform(props){
    ...
    const [hideFormState, setHideFormState] = useState(true);
    ...
    const showForm = () => {setHideFormState(false)};
    const hideForm = () => {setHideFormState(true)};
  

    if (hideFormState){
        return <button onClick = {showForm}>Add New Expenses</button>
    }
